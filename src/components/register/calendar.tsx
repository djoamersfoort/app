...
import {MultiChange, MultiConfirm} from "react-native-paper-dates/lib/typescript/Date/Calendar";
import {format, subDays} from "date-fns";
import {AANMELDEN} from "../../env";
import {DatePickerModal} from "react-native-paper-dates";

export default function Calendar({ open, setOpen }: { open: boolean, setOpen: (open: boolean) => void }) {
